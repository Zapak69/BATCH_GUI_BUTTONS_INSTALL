...
:SLoop
    ...
    :: Make the hor line
    set "HL=" & for /l %%i in (1,1,!_Lng[B]!) do (set HL=!HL! /a 205 )
    ...
    :: Make the button
    set Top_Left=/g %XBPB% %YBPB% /a 201
    set Top_Rihgt=/g %XBPE% %YBPB% /a 187
    set Base_Left=/g %XBPB% %YBPE% /a 200
    set Base_Right=/g %XBPE% %YBPE% /a 188
    set Hor_Line=/g %XBPM% %YBPB% !HL! /g %XBPM% %YBPE%  !HL!
    set Ver_Line=/g %XBPB% %YBPM% /a 186 /g %XBPE% %YBPM% /a 186
